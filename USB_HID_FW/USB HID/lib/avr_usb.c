...
#define STR_MANUFACTURER	L"Nilesh Mundphan"
#define STR_PRODUCT		L"HID Data Example"
...
static const const uint8_t PROGMEM const endpoint_config_table[] = {
...
static const uint8_t PROGMEM const config1_descriptor[CONFIG1_DESC_SIZE] = {
